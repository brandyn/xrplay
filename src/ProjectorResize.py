    ...
    def invoke(self, source_image, dest_image):
        ...
        try:
            ...
            try:
                ...
                if self.input_width == self.output_width and self.input_height == self.output_height:
                ...
                elif self.output_width > self.input_width or self.output_height > self.input_height:
                    # FIXME: untested case
